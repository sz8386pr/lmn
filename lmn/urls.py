...
from . import views, views_artists, views_venues, views_notes, views_users, views_userprofile
...
urlpatterns = [
    ...
    url(r'^user/myprofile/$',views_userprofile.my_profile, name = 'my_profile'),
